...
export class ToastStyles {
  /**
   * Get toast style based on props
   */
  static getStyle(props: ToastProps) {
   ...
   */
  private static getVariantStyle(variant: ToastVariants) {
    switch (variant) {
      case 'primary':
        return {
   ...
   */
  private static getSizeStyle(size: ToastSizes) {
    switch (size) {
      case 'xs':
        return {
          padding: {
   ...
   */
  private static getStateStyle(state: ToastStates) {
    switch (state) {
      case 'hover':
        return {
  ...
  /**
   * Get custom styles based on toast props
   */
  private static getCustomStyle(props: ToastProps) {
  ...
  /**
   * Get toast style for specific variant/size/state combination
   */
  ...
  /**
   * Get all available toast styles
   */
  static getAllStyles() {
    const variants: ToastVariants[] = ['default', 'primary', 'secondary', 'success', 'warning', 'error', 'info', 'outline', 'ghost', 'striped', 'animated', 'gradient'];
    const sizes: ToastSizes[] = ['xs', 'sm', 'md', 'lg', 'xl'];
    const states: ToastStates[] = ['default', 'hover', 'active', 'disabled', 'focus', 'error', 'success', 'loading', 'complete', 'indeterminate'];
