...
export class TableStyles {
  /**
   * Get table style based on props
   */
  static getStyle(props: TableProps) {
   ...
   */
  private static getVariantStyle(variant: TableVariants) {
    switch (variant) {
      case 'primary':
        return {
   ...
   */
  private static getSizeStyle(size: TableSizes) {
    switch (size) {
      case 'xs':
        return {
          padding: {
   ...
   */
  private static getStateStyle(state: TableStates) {
    switch (state) {
      case 'hover':
        return {
  ...
  /**
   * Get custom styles based on table props
   */
  private static getCustomStyle(props: TableProps) {
  ...
  /**
   * Get table style for specific variant/size/state combination
   */
   ...
   */
  static getAllStyles() {
    const variants: TableVariants[] = ['default', 'primary', 'secondary', 'success', 'warning', 'error', 'info', 'outline', 'ghost', 'striped', 'animated', 'gradient'];
    const sizes: TableSizes[] = ['xs', 'sm', 'md', 'lg', 'xl'];
    const states: TableStates[] = ['default', 'hover', 'active', 'disabled', 'focus', 'error', 'success', 'loading', 'complete', 'indeterminate'];
