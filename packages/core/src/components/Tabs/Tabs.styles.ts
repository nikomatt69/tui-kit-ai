...
export class TabsStyles {
  /**
   * Get tabs style based on props
   */
  static getStyle(props: TabsProps) {
   ...
   */
  private static getVariantStyle(variant: TabsVariants) {
    switch (variant) {
      case 'primary':
        return {
   ...
   */
  private static getSizeStyle(size: TabsSizes) {
    switch (size) {
      case 'xs':
        return {
          padding: {
   ...
   */
  private static getStateStyle(state: TabsStates) {
    switch (state) {
      case 'hover':
        return {
  ...
  /**
   * Get custom styles based on tabs props
   */
  private static getCustomStyle(props: TabsProps) {
  ...
  /**
   * Get tabs style for specific variant/size/state combination
   */
  ...
  /**
   * Get all available tabs styles
   */
  static getAllStyles() {
    const variants: TabsVariants[] = ['default', 'primary', 'secondary', 'success', 'warning', 'error', 'info', 'outline', 'ghost', 'striped', 'animated', 'gradient'];
    const sizes: TabsSizes[] = ['xs', 'sm', 'md', 'lg', 'xl'];
    const states: TabsStates[] = ['default', 'hover', 'active', 'disabled', 'focus', 'error', 'success', 'loading', 'complete', 'indeterminate'];
