...
export class SelectStyles {
  /**
   * Get select style based on props
   */
  static getStyle(props: SelectProps) {
   ...
   */
  private static getVariantStyle(variant: SelectVariants) {
    switch (variant) {
      case 'primary':
        return {
   ...
   */
  private static getSizeStyle(size: SelectSizes) {
    switch (size) {
      case 'xs':
        return {
          padding: {
   ...
   */
  private static getStateStyle(state: SelectStates) {
    switch (state) {
      case 'hover':
        return {
  ...
  /**
   * Get custom styles based on select props
   */
  private static getCustomStyle(props: SelectProps) {
  ...
  /**
   * Get select style for specific variant/size/state combination
   */
  ...
  /**
   * Get all available select styles
   */
  static getAllStyles() {
    const variants: SelectVariants[] = ['default', 'primary', 'secondary', 'success', 'warning', 'error', 'info', 'outline', 'ghost', 'striped', 'animated', 'gradient'];
    const sizes: SelectSizes[] = ['xs', 'sm', 'md', 'lg', 'xl'];
    const states: SelectStates[] = ['default', 'hover', 'active', 'disabled', 'focus', 'error', 'success', 'loading', 'complete', 'indeterminate'];
