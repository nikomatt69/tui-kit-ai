...
export class SpinnerStyles {
  /**
   * Get spinner style based on props
   */
  static getStyle(props: SpinnerProps) {
   ...
   */
  private static getVariantStyle(variant: SpinnerVariants) {
    switch (variant) {
      case 'primary':
        return {
   ...
   */
  private static getSizeStyle(size: SpinnerSizes) {
    switch (size) {
      case 'xs':
        return {
          padding: {
   ...
   */
  private static getStateStyle(state: SpinnerStates) {
    switch (state) {
      case 'hover':
        return {
  ...
  /**
   * Get custom styles based on spinner props
   */
  private static getCustomStyle(props: SpinnerProps) {
    ...
    if (props.spinnerStyle === 'detailed') {
      customStyle.padding = {
        left: 4,
        right: 4,
        top: 3,
  ...
  /**
   * Get spinner style for specific variant/size/state combination
   */
   ...
   */
  static getAllStyles() {
    const variants: SpinnerVariants[] = ['default', 'primary', 'secondary', 'success', 'warning', 'error', 'info', 'outline', 'ghost', 'striped', 'animated', 'gradient'];
    const sizes: SpinnerSizes[] = ['xs', 'sm', 'md', 'lg', 'xl'];
    const states: SpinnerStates[] = ['default', 'hover', 'active', 'disabled', 'focus', 'error', 'success', 'loading', 'complete', 'indeterminate'];
